...
import com.project.bank.utils.Input;
...
public class ATM {
	...
	private void adminMenu() {
		...
		while(true) {
			var choice=keyboard.readInt("1. open account 2. credit interest 3. view all accounts 4. Return to Start 0. exit ?");
			switch(choice) {
				case 0:
					return ;
	...
	private void openAccount(){
		...
		int accNumber = bank.openAccount(name, password, balance, type);
		System.out.println("Account created Successfully and your account number is:" + accNumber);
	}
