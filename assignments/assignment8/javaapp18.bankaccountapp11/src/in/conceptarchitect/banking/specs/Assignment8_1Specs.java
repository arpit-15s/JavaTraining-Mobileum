...
import in.conceptarchitect.utils.encryption.Search;
...
public class Assignment8_1Specs {
	...
	public void searchCanReturnAllCurrentAccounts() {
		...
		selectedAccounts = searchObj.searchCurrentAccount(accounts);
	...
	public void searchCanReturnAccountWithNegativeBalance() {
		 //search for accounts with negative balance
		selectedAccounts = searchObj.searchNegativeBalanceAccount(accounts);
	...
	public void searchCanReturnAllAccountWithLastNameMishra() {
		...
		selectedAccounts = searchObj.searchLastNameMishra(accounts);new ArrayList<BankAccount>();
