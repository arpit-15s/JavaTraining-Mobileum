package com.project.banking.frontend;

import com.project.banking.Bank;
import com.project.banking.exceptions.BankingException;
...
public class ATM {
	...
	private void adminMenu() {
		...
		while (true) {
			...
			var choice = keyboard
					.readInt("1. open account 2. credit interest 3. view all accounts 4. shutdown atm 5. Back to Start Menu 0. exit ?");
			switch (choice) {
	...
	private void mainMenu() {
		...
		while (true) {
			...
			try {
				var choice = keyboard
						.readInt("1. deposit 2. withdraw 3. check balance 4. transfer 5. close account 6. Return to Start Menu 0. exit ?");
				switch (choice) {
				case 1:
					doDeposit();
					break;
